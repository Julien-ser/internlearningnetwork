...
describe('Auth Controller', () => {
    ...
    describe('POST /auth/register', () => {
        it('should register a new user successfully', async () => {
            ...
            setup_1.prisma.user.findFirst.mockResolvedValue(null);
            setup_1.prisma.user.create.mockResolvedValue(mockUser);
        ...
        it('should return 409 if user with email already exists', async () => {
            ...
            setup_1.prisma.user.findFirst.mockResolvedValue(existingUser);
            const response = await (0, supertest_1.default)(index_1.app)
                .post('/api/auth/register')
                .send({
                email: 'test@example.com',
    ...
    describe('POST /auth/login', () => {
        it('should login successfully with valid credentials', async () => {
            ...
            setup_1.prisma.user.findUnique.mockResolvedValue(user);
            const response = await (0, supertest_1.default)(index_1.app)
                .post('/api/auth/login')
                .send({
                email: 'test@example.com',
